...
import { AddProduct, FileUploadToWinbri } from '../../../Functions/WinbriLifeScience'
// import { GetCategories } from '../../../Functions/Winbri/Categories'
// import { GetFabric } from '../../../Functions/Winbri/Fabric'
// import { GetSubCategories } from '../../../Functions/Winbri/SubCategories'
...
const AddProducts = () => {
	...
	const handleVariantImageChange = async (
		...
		if (!file) return
		try {
			const res: any = await FileUploadToWinbri([file], { directory: 'files' })
	...
	const handleAddImageChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
		...
		if (!file) return
		try {
			const imageUrl: any = await FileUploadToWinbri([file], { directory: 'files' })
							...
							<div className='row'>
								...
								{imageArray.length > 0 ? (
									...
									<div className='col-md-2 mb-5 text-center'>
										<img
											alt='Photos'
											src={formData.display_image || '/media/logos/winbri-logo.png'}
											style={{ borderRadius: '10px', width: '95%' }}
										/>
									</div>
								)}
										...
										<div className='row'>
											...
											{variant.images?.length > 0 ? (
												...
												<div className='col-md-2 mb-5 text-center'>
													<img
														alt='Photos'
														src={'/media/logos/winbri-logo.png'}
														style={{ borderRadius: '10px', width: '95%' }}
													/>
												</div>
											)}
