...
const UserView = () => {
	...
	const fetchFitnessCourseData = async () => {
		...
		try {
			...
			const fitness_course_response: any = {}
	...
	const delete_user = async () => {
		try {
			...
			navigate('/winbri-life-science/users')
		} catch (error: any) {
			toast.error(error.message)
			console.error(error)
		}
	...
	const handleFileUpload = async (event: any, type: any) => {
		...
		const imageUrl: any = await FileUploadToWinbri([file], {
			directory: 'users',
		})
						...
						<div className='row flex-column'>
							<div className='row'>
								...
								<div className='col-md-3 my-2'>
									<Link
										className='text-dark'
										to={'/winbri-life-science/fitness-courses?user_id=' + userResponseData._id}>
										<div
											className='category-box d-flex align-items-center'
											style={{
												backgroundColor: 'transparent',
							...
							<div className='row'>
								<div className='col-md-3 my-2'>
									<Link
										className='text-dark'
										to={'/winbri-life-science/book-order?user_id=' + userResponseData._id}>
										<div
											className='category-box d-flex align-items-center'
											style={{
												backgroundColor: 'transparent',
								...
								<div className='col-md-3 my-2'>
									<Link
										className='text-dark'
										to={'/winbri-life-science/all-order?user_id=' + userResponseData._id}>
										<div
											className='category-box d-flex align-items-center'
											style={{
												backgroundColor: 'transparent',
											...
											<tr key={index}>
												...
												<td>
													<div className='d-flex justify-content-center'>
														<TableButton
															action='view'
															to={`/winbri-life-science/user/user-fitness-course-view?user_fitness_course_id=${user._id}`}
														/>
