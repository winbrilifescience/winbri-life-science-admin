...
import { GetUsers, LockUnlockUser } from '../../../../Functions/WinbriLifeScience'
...
const Users: React.FC = () => {
	...
	const masterData = localStorage.getItem('winbri_master')
				...
				<div className='row align-items-center justify-content-between'>
					...
					<div className='col-sm-6 col-12 card-header border-0 d-flex justify-content-md-end '>
						<div className='card-toolbar'>
							...
							<TableButton
								action='add'
								to='/winbri-life-science/users/add-user'
								text='Add'
							/>
						</div>
					</div>
									...
									<tr
										...
										<td>
											<div className='d-flex'>
												<TableButton
													action='view'
													to={`/winbri-life-science/users/view-user?user_id=` + data._id}
												/>
												{data.lock ? (
													<button
