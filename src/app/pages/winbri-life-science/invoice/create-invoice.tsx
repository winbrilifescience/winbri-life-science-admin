...
import { createInvoice, getNextInvoiceSequence } from '../../../Functions/WinbriLifeScience'
import { invoiceSchema } from '../../../modules/validation/validation'

const CreateInvoiceWINBRI: React.FC = () => {
	...
	const handleCreateInvoice = async (event: any) => {
		...
		try {
			...
			const payload: any = {
				invoice_category: 'Winbri Life Science',
	...
	const fetchInvoiceData = async () => {
		try {
			const response: WinbriAPIResponse | any = await getNextInvoiceSequence({
				invoice_category: 'Winbri Life Science',
			})
			if (response.data) {
									...
									<div className='invoice-header row mt-2 p-3'>
										...
										<div className='col-md-4'>
											<div className='text-center'>
												<img
													src='/media/logos/winbri-life-science-logo.png'
													width='60%'
													alt='Company Logo'
												/>
											</div>
						...
						<div className='card-body'>
							<div id='invoiceTermAndCondition'>
								<p className='fw-bold fs-5 text-center mb-2'>
									WINBRI Academy - Rules & Regulations for Enrolled Students
								</p>
								<div className='border'>
									<div className='invoice-details d-flex'>
										<div className='col-md-12 border px-0'>
											...
											<div className='px-2'>
												<p
													style={{ fontSize: '12px' }}
													className='mt-1'>
													Welcome to WINBRI Academy, where we are committed to delivering
												...
												<div>
													...
													<p
														...
														topic through pre-recorded sessions available in the WINBRI App.
													</p>
													<p style={{ fontSize: '12px' }}>
												...
												<div>
													...
													<p
														...
														information or approval from the WINBRI team:
														<ul>
												...
												<div>
													...
													<p
														...
														are available only through the official WINBRI App.
													</p>
													<p style={{ fontSize: '12px' }}>
...
export default CreateInvoiceWINBRI
