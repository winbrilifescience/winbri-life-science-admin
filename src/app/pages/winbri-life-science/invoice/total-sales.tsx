...
import { getInvoice } from '../../../Functions/WinbriLifeScience'

type InvoiceCategory = 'Private' | 'Winbri Life Science'

const TotalSalesList: React.FC = () => {
	...
	const fetchInvoiceData = async (page?: number) => {
		setLoading(true)
		try {
			const category: InvoiceCategory = 'Winbri Life Science'
			let startDate: Date
			let endDate: Date
						...
						<div className='card-toolbar d-flex justify-content-end'>
							<div className='row justify-content-between'>
								<div className='col-md-12'>
									<TableButton
										action='add'
										to='/winbri-life-science/invoice/create'
										text='Create Invoice'
									/>
								</div>
									...
									<tr
										...
										<td>
											{item?.fullName ? (
												<TableButton
													action='edit'
													to={`/winbri-life-science/invoice/fwg-update?invoice_id=` + item._id}
												/>
											) : (
												<TableButton
													action='edit'
													to={`/winbri-life-science/invoice/update?invoice_id=` + item._id}
												/>
											)}
										</td>
									</tr>
															...
															<img
																src={
																	item.profile_image
																		...
																		: toAbsoluteUrl('/media/logos/winbri-life-science-logo.png')
																}
																alt='User'
