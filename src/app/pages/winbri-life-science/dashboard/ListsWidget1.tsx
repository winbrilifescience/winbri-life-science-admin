	...
	return (
		<div className='card card-xl-stretch mb-5 mb-xl-8'>
			<div className='card-header border-0'>
				<h3 className='card-title fw-bold text-dark'>Winbri Life Science</h3>
			</div>

			<div className='card-body pt-0'>
				{/* Registered Users */}
				<Link to='/winbri-life-science/users'>
				...
				{/* Scholarship Result */}
				<Link to='/winbri-life-science/scholarship-result'>
				...
				{/* Week Inquiry */}
				<Link to='/winbri-life-science/contact-inquiry/contact'>
				...
				{/* Total Order */}
				<Link to='/winbri-life-science/all-order'>
				...
				{/* RTP Consultancy */}
				<Link to='/winbri-life-science/rtp-consultancy'>
				...
				<Link to='/winbri-life-science/seminar-registration'>
