			...
			<div>
				<div className='card-header border-0 pt-5'>
					<h3 className='card-title align-items-start flex-column'>
						<span className='card-label fw-bold text-dark'>WINBRI</span>
					</h3>
				...
				<div className='card-body pt-5'>
					<Link to='/winbri-life-science/student-dashboard'>
					...
					<Link to='/winbri-life-science/books'>
						<div className='d-flex align-items-sm-center mb-7'>
							<div className='symbol symbol-50px me-5'>
								<span className='symbol-label'>
									<FontAwesomeIcon
					...
					<Link to='/winbri-life-science/e-book'>
						<div className='d-flex align-items-sm-center mb-7'>
							<div className='symbol symbol-50px me-5'>
								<span className='symbol-label'>
									<FontAwesomeIcon
				...
				<div className='card-body pt-0'>
					{/* Digital Plan */}
					<Link to='/winbri-life-science/digital-plan-order'>
					...
					{/* PT Plan */}
					<Link to='/winbri-life-science/fitness-plan'>
