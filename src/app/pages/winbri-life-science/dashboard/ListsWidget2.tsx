	...
	return (
		<div className='card card-xl-stretch mb-5 mb-xl-8'>
			...
			<div className='card-body pt-0'>
				...
				{/* <Link to='/winbri-life-science/fitness-courses'>
				...
				{/* Book Order */}
				{/* <Link to='/winbri-life-science/book-order'>
				...
				{/* E-Book Order */}
				{/* <Link to='/winbri-life-science/e-book-order'>
				...
				{/* Product */}
				{/* <Link to='/winbri-life-science/product-order'>
